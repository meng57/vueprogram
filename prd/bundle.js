...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shouye = __webpack_require__(8);
	
	var _shouye2 = _interopRequireDefault(_shouye);
	
	var _fenlei = __webpack_require__(13);
	
	var _fenlei2 = _interopRequireDefault(_fenlei);
	
	var _shopping = __webpack_require__(16);
	...
	router.map({
	  '/': {
	    ...
	    subRoutes: {
	      '/': {
	        component: _shouye2.default
	      },
	      '/fenlei': {
	        component: _fenlei2.default
	      },
	      '/shopping': {
...
/***/ function(module, exports) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      cur: 0,
	      tablist: [{ path: '/', icon: '&#xe603;', name: '首页' }, { path: '/fenlei', icon: '&#xe601;', name: '分类' }, { path: '/shopping', icon: '&#xe653;', name: '购物车' }, { path: '/my', icon: '&#xe609;', name: '我的诺心' }]
	    };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\scripts\\components\\shouye.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         </nav>
	//     <div class="mainbody">
	//         <img v-for="img in imglist" v-bind:src="img"/>
	//     </div>
	//     <div class="mainfooter">
	//       <ul>
	//         <li><img v-bind:src="phone"/></li>
	//         <li><img v-bind:src="pc"/></li>
	//       </ul>
	//       <p>copyright©2010-2016诺心lecake.com版权所有</p>
	//     </div>
	//       </section>
	//     </div>
	//   </div>
	...
	exports.default = {
	  data: function data() {
	    return {
	      imglist: ['/images/langman.jpg', '/images/party.jpg', '/images/childhood.jpg', '/images/afternoon.jpg', '/images/birthday.jpg', '/images/thanksgiving.jpg'],
	      pc: '/images/pc.png',
	  ...
	  ready: function ready() {
	    ...
	    var myScroll = new IScroll('.main-container', {
	      // // probeType: 3,
	      // mouseWheel: true,
	      // click: true,
	      // scrollY: true
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] src\\scripts\\components\\fenlei.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	//         </div>
	//     </header>
	//     <section class="fenlei-section">
	//       <div class="fenlei-div">
	//         <ul>
	//           <li v-for="l in product" v-link="{path: '/detail'}">
	//             <img v-bind:src="l.url"/>
	//             <span>{{l.name}}</span>
	//             <span>{{l.description}}</span>
	//             <span>{{l.price}}</span>
	//             <span>{{l.weigh}}</span>
	//           </li>
	//             <li class="fenlei-footer">—&nbsp;没有更多产品咯&nbsp;—</li>
	//         </ul>
	//
	//       </div>
	//
	...
	exports.default = {
	  data: function data() {
	    return {
	      img: '/images/ico-location.png',
	      product: [{
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10800/thumb_10800.jpg",
	        name: "雪域牛乳芝士蛋糕",
	        description: "Le Cheesecake",
	        price: "￥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201405/12775/thumb_12775.jpg",
	        name: "提拉米苏乐脆蛋糕",
	        description: "Tiramisu Crispy",
	        price: "￥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201609/14533/thumb_14533.jpg",
	        name: "鬼马小精灵蛋糕",
	        description: "Le Phantom Cake",
	        price: "￥218",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201609/14579/thumb_14579.jpg",
	        name: "栗香飘飘",
	        description: "Chestnut Pie",
	        price: "￥218",
	        weigh: "1.6磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201310/12287/thumb_12287.jpg",
	        name: "环游世界·秋冬季蛋糕",
	        description: "Around The World Cake",
	        price: "￥218",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201211/10491/thumb_10491.jpg",
	        name: "雪域蓝莓芝士蛋糕",
	        description: "Blueberry Cheesecake/Emily",
	        price: "￥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201308/12244/thumb_12244.jpg",
	        name: "玫瑰雪域芝士蛋糕",
	        description: "Rose Cheesecake",
	        price: "￥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10782/thumb_10782.png",
	        name: "海盐乳酪芝士蛋糕",
	        description: "Parmesan Cheesecake",
	        price: "¥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10648/thumb_10648.jpg",
	        name: "巧克力松露蛋糕",
	        description: "Chocolate Marquise",
	        price: "¥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201303/12085/thumb_12085.jpg",
	        name: "蓝莓拿破仑蛋糕",
	        description: "Blueberry Mille-feuilles",
	        price: "¥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201301/10923/thumb_10923.jpg",
	        name: "草莓拿破仑蛋糕",
	        description: "Strawberry Mille-feuilles",
	        price: "¥198.00",
	        weigh: "1磅"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10800/thumb_10800.jpg",
	  ...
	  ready: function ready() {
	    Vue.nextTick(function () {
	      setTimeout(function () {
	        var myscroll = new IScroll('.fenlei-section', {
	          scrollY: true,
	          mouseWheel: true,
	          click: true
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      img: "/images/ico-back.png",
	      cart: "http://rescdn.lecake.com/shop/lecake/theme/xth2/tpls/wechat/images_new/cart/no-content.png",
	      list: [{
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201605/14163/thumb_14163.jpg",
	        title1: "餐具(5个一套)",
	        title2: "￥2.50"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201310/12278/thumb_12278.jpg",
	        title1: "金色蜡烛",
	        title2: "￥10.00"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10844/thumb_10844.jpg",
	        title1: "Happy Birthday",
	        title2: "￥10.00"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201404/12663/thumb_12663.jpg",
	        title1: "I LOVE MAMA",
	        title2: "￥15.00"
	      }, {
	        url: "http://imagecdn.lecake.com/postsystem/docroot/images/goods/201212/10841/thumb_10841.jpg",
	        title1: "I love papa",
	        title2: "￥10.00"
	      }]
	    };
	  ...
	  ready: function ready() {
	    var oneScroll = new IScroll('.fitting', {
	      scrollX: true
	    });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  data: function data() {
	    return {
	      img: "/images/ico-back.png",
	      img1: "http://rescdn.lecake.com/shop/lecake/theme/xth2/tpls/wechat/images_new/customer/avatar.png"
	    };
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    switch1: function switch1(index) {
